...
describe('Observable.prototype.withLatestFrom', function () {
  it('withLatestFrom should combine events from cold observables', function () {
  ...
  it('should handle promises', function (done) {
    Observable.of(1)
      .delay(1)
      .withLatestFrom(Promise.resolve(2), Promise.resolve(3))
      .subscribe(
        function (x) {
  ...
  it('should handle lowercase-o observables', function () {
    Observable.of(1)
      .delay(1)
      .withLatestFrom(lowerCaseO(2, 3, 4), lowerCaseO(4, 5, 6))
      .subscribe(function (x) {
        expect(x).toEqual([1, 4, 6])
      })
  })
