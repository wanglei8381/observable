...
describe('Observable.prototype.combineLatest', function () {
  it('combineLatest should combine events from two cold observables', function () {
  ...
  it.skip('should emit unique array instances with the default projection', function () {
    var e1 = hot('-a--b--|')
    var e2 = hot('--1--2-|')
    var expected = '-------(c|)'
    var result = e1
